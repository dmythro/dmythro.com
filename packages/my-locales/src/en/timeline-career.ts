...
export const careerTimeline: TimelineItem[] = [
  {
    ...
    description: [
      'I did a complete rework and further improvement of the client app, added role-based auth, CI/CD, 3D models prview, AR for mobile phones (USDZ/GLB) and created a custom admin panel during a 2-month contract.',
