I play a multi-scale eight-string guitar, and every time I ordered strings for it I was guessing. The scale length changes under every string, so a gauge that sits right under the low F# is a rubber band up at the high E — and every tension calculator I could find asked for one scale length and six strings.
