...
Every ISO 3166-1 code and then some, zero dependencies, types included. `countries.` autocompletes in your editor, and a wrong code is a compile error rather than an `undefined` at runtime.
...
Live and maintained since 2014. Corrections arrive as pull requests from people who live in the places being described — the only review process that reliably catches this class of error.
