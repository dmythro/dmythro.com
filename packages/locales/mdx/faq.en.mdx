...
Sure, I love open source community and contribute where I can. My biggest NPM module `countries-list` has [%%githubStars%% stars on GitHub](https://github.com/annexare/Countries) and [%%npmDownloads%%/mo downloads on NPM](https://www.npmjs.com/package/countries-list). You can check them on the [Projects](/en/projects) page.
