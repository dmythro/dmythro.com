...
Звичайно, люблю та підтримую спільноту з відкритим кодом де можу. Мій найбільший NPM модуль `countries-list` має [~1.3к зірок на GitHub](https://github.com/annexare/Countries) та [1.5M+ зкачувань на місяць на NPM](https://www.npmjs.com/package/countries-list). Більше проєктів на сторінці [Проєкти](/uk/projects).
...
- Кинув курити у 7 років — після першої ж сигарети (батько навмисно дав спробувати, знав що не сподобається!)
- Колекціоную Pink Floyd з 6 років
- Створив перший комерційний програмний проєкт у 17 років (кінець 2003)
- Кандидат в майстри спорту з плавання
- Одночасно закінчив три школи: середню, музичну та спортивну
