...
export const careerTimeline: TimelineItem[] = [
  {
    ...
    description: [
      ...
      "CI/CD, код-рев'ю, робота з AI.",
      'Суттєве покращення PageSpeed і продуктивності бекенду.',
    ],
  },
  {
    isHighlighted: true,
    ...
    description: [
      'Я повністю переробив і вдосконалив клієнтський фул-стек DAM (управління цифровими активами) веб-сервіс, додав авторизацію на основі ролей, CI/CD, перегляд 3D-моделей, AR для мобільних телефонів (USDZ/GLB) та створив спеціальну панель адміністратора протягом першого 2-місячного контракту.',
  ...
  },
  {
    ...
    description: [
      ...
      "Інтегрував всі необхідні для бізнесу сторонні сервіси та веб-хуки (Sentry, SendBird, Segment, Customer.io, Mixpanel та інші). Офіцер з безпеки. Брав участь у різноманітних аудитах інфраструктури та безпеки. Займався код рев'ю всіх проєктів (API, адмінпанель, мобільний додаток), менторством та технічною стороною управління командою.",
  ...
  },
  {
    ...
    till: 'Гру ’12',
    where: 'UA',
    title: 'Робота над власними проєктами',
    description: [
      ...
      'Soccer City. Гра у реальному часі для соціальних мереж (Facebook та інші) з Flash GUI, PHP/MySQL бекендом та різними інтегрованими API соціальних мереж та платежів. Гра комбінувала ізометричний сіті-білдер та онлайн матч-мейкінг що враховував як показники команди так і деякий фактор випадковості. З квестами, досягненнями, внутрішньоігрові покупки тощо. Це був досить непростий проєкт. Але коли Flash пішов з браузерів ми не стали переробляти клієнт для сучасних браузерів і закрили.',
    ],
  },
  {
    when: 'Чер ’10',
