...
export const generalTimeline: TimelineItem[] = [
  ...
  },
  {
    ...
    subtitle: 'КНУБА, ФАІТ',
    description: [
      'Випускник Київського національного університету будівництва і архітектури, факультет Автоматизації і інформаційних технологій.',
      "Спеціальність: 015.10 «Професійна освіта. Комп'ютерні технології». Поєднання технічної експертизи з педагогікою для створення кращих інструментів профорієнтації студентів.",
    ],
  },
  {
    when: '2014',
  ...
  },
  {
    ...
    description: [
      ...
      'Призові місця на олімпіадах з математики та фізики, публікації в Малій академії наук, участь у виставках малюнків.',
      'Створив перший комерційний проєкт у 17 років — Win32-додаток для роботи з CD/DVD.',
    ],
  },
]
