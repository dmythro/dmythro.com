...
export const uk: Translation = {
  ...
  builtWithVersions:
    'Репозиторій містить дві версії цього вебсайту, обидві мають ідеальні результати PageSpeed/Lighthouse. Я залишаю обидві, бо кожен стек має свої сильні сторони — для простого сайту як цей, обидва варіанти чудово підходять. Для складніших проєктів вибір має базуватися на конкретних вимогах та перевагах кожного фреймворку.',
  ...
  guitars: {
    stringTension: {
      pageTitle: 'Гітари',
      title: 'Калькулятор натягу гітарних струн',
      description:
      ...
      // Виноска під калькулятором із посиланням на опис проєкту
      aboutNote: 'Як це працює і звідки числа —',
      aboutLink: 'читайте повний опис проєкту',
